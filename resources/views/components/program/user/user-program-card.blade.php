...
<x-card class="w-full max-h-105 md:w-[calc(50%_-_0.75rem)] md:max-h-full">
    ...
    <div class="w-full">
        ...
        class="mx-auto w-full h-40 object-cover rounded-md block md:h-75">
    </div>
    ...
    <div class="buttons flex flex-wrap gap-2 justify-between">
