...
class UpdateProgramRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'weeks.*.days.*.exercises.*.percentage' => ['nullable', 'integer', 'min:1', 'max:200'],
            ...
            'weeks.*.days.*.new_exercises.*.sets' => ['required', 'integer', 'min:1', 'max:30'],
            'weeks.*.days.*.new_exercises.*.reps' => ['required', 'integer', 'min:1', 'max:50'],
            'weeks.*.days.*.new_exercises.*.percentage' => ['nullable', 'integer', 'min:1', 'max:200'],
            'weeks.*.days.*.new_exercises.*.rpe' => ['nullable', 'numeric', 'min:1', 'max:10'],
            'weeks.*.days.*.new_exercises.*.duration_minutes' => ['nullable', 'numeric', 'min:0.1', 'max:120'],
            'weeks.*.days.*.new_exercises.*.position' => ['required', 'integer'],
    ...
    protected $errorBag = 'updateProgramError';
}
